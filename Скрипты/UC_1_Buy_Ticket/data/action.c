Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=129613.892345079zzzHAVtpfiHftAAAcpAiHfcf", ENDITEM, 
	...
	lr_start_transaction("FillFieldsAboutFlight");
	...
	lr_end_transaction("FillFieldsAboutFlight",LR_AUTO);
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=010;386;09/15/2020", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=Coach", ENDITEM, 
		"Name=seatPref", "Value=Aisle", ENDITEM, 
	...
	web_submit_data("reservations.pl_3", 
		...
		"Name=address1", "Value=perm", ENDITEM, 
		"Name=address2", "Value=lenia", ENDITEM, 
		"Name=pass1", "Value=Jojo Bean", ENDITEM, 
		"Name=creditCard", "Value=2324325253454", ENDITEM, 
